...
m.DERcompleteModel_pCold = DerivativeVar(m.completeModel_pCold, initialize = 0.0)
m.scaling_factor[m.DERcompleteModel_pCold] = m.scaling_factor[m.completeModel_pCold]*dt
m.DERcompleteModel_pHot = DerivativeVar(m.completeModel_pHot, initialize = 0.0)
m.scaling_factor[m.DERcompleteModel_pHot] = m.scaling_factor[m.completeModel_pHot]*dt
m.DERcompleteModel_Tcold_2 = DerivativeVar(m.completeModel_Tcold_2, initialize = -6.237513376087475e-14)
m.scaling_factor[m.DERcompleteModel_Tcold_2] = m.scaling_factor[m.completeModel_Tcold_2]*dt
m.DERcompleteModel_Thot_2 = DerivativeVar(m.completeModel_Thot_2, initialize = 2.3457303687755434e-15)
m.scaling_factor[m.DERcompleteModel_Thot_2] = m.scaling_factor[m.completeModel_Thot_2]*dt
m.DERcompleteModel_Twall_1 = DerivativeVar(m.completeModel_Twall_1, initialize = 4.127366901957216e-15)
m.scaling_factor[m.DERcompleteModel_Twall_1] = m.scaling_factor[m.completeModel_Twall_1]*dt
m.DERcompleteModel_Tcold_3 = DerivativeVar(m.completeModel_Tcold_3, initialize = -1.320736277921827e-14)
m.scaling_factor[m.DERcompleteModel_Tcold_3] = m.scaling_factor[m.completeModel_Tcold_3]*dt
m.DERcompleteModel_Thot_3 = DerivativeVar(m.completeModel_Thot_3, initialize = 2.5310238256793192e-15)
m.scaling_factor[m.DERcompleteModel_Thot_3] = m.scaling_factor[m.completeModel_Thot_3]*dt
m.DERcompleteModel_Twall_2 = DerivativeVar(m.completeModel_Twall_2, initialize = 4.3733689027361235e-16)
